...
3. **Processing**
   ...
   * *Body axis to vehicle axis* — ось, медиана которой близка к ±1 g, содержит гравитацию и заранее
     выбрана как **Vertical**; из двух оставшихся выберите, какая направлена поперёк машины
     (**Lateral**), а какая вдоль (**Longitudinal**). Поставьте *invert*, если «вправо» / «вперёд»
